...
public    class MethodMetadataTest
    {
        ...
        private byte[] _method1Bytes = {
                                           0x34, 0x34, 0x21, 0x00, 0x01, 0x00, 0x00, 0x06, 0x08, 0x00, 0x00, 0x00, 0x4D,
                                           0x00, 0x61, 0x00, 0x69, 0x00, 0x6E, 0x00, 0x01, 0x00, 0x00, 0x00, 0x08, 0x00,
                                           0x00, 0x00, 0x61, 0x00, 0x72, 0x00, 0x67, 0x00, 0x73, 0x00, 0x6C, 0x34, 0x21,
                                           0x00
                                       };

        private byte[] _method2Bytes = {
                                           0x4C, 0x34, 0x21, 0x00, 0x03, 0x00, 0x00, 0x06,
                                           0x16, 0x00, 0x00, 0x00, 0x4F, 0x00, 0x74, 0x00, 0x68, 0x00, 0x65, 0x00, 0x72,
                                           0x00, 0x4D, 0x00, 0x65, 0x00, 0x74, 0x00, 0x68, 0x00, 0x6F, 0x00, 0x64, 0x00,
                                           0x00, 0x00, 0x00, 0x00, 0x6C, 0x34, 0x21, 0x00
                                       };

        private byte[] _method3Bytes = {
                                           
                                       };
        ...
        {
            Assert.IsTrue(object.ReferenceEquals(_classMetadata, _methodMetadata1.Class), "Method1's parent module does not match.");
            Assert.IsTrue(object.ReferenceEquals(_classMetadata, _methodMetadata2.Class), "Method2's parent module does not match.");
            Assert.IsTrue(object.ReferenceEquals(_classMetadata, _methodMetadata3.Class), "Method3's parent module does not match.");
        }
